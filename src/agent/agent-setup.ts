...
export const HAULER_TEMPLATE: BodyTemplate = {
  bodyParts: [
    ...
    [CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], // 6-CARRY 4-MOVE
    [CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], // 8-CARRY 4-MOVE
    [CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 12-CARRY 6-MOVE
...
export const HARVEST_REMOTE_BASIC_STRUCTURE_TEMPLATE: BodyTemplate = {
  bodyParts: [
    [WORK, WORK, MOVE, MOVE],
    [WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE],
    [WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE], // 5-WORK 5-MOVE
  ]
};
...
export const UPGRADER_TEMPLATE: BodyTemplate = {
  bodyParts: [
    ...
    [WORK, CARRY, CARRY, MOVE, MOVE], // 1-WORK 2-CARRY 2-MOVE
    [WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE], // 5-WORK 1-CARRY 3-MOVE
    [WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], // 8-WORK 2-CARRY 5-MOVE
...
export const UPGRADER_BATTERY_TEMPLATE: BodyTemplate = {
  bodyParts: [
    ...
    [WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], // 8-WORK 2-CARRY 5-MOVE
    // [WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 10-WORK 2-CARRY 6-MOVE
    [WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 15-WORK 2-CARRY 8-MOVE
  ]
};

export const UPGRADER_REMOTE_TEMPLATE: BodyTemplate = {
  bodyParts: [
    [WORK, CARRY, MOVE, MOVE],
    [WORK, CARRY, CARRY, MOVE, MOVE, MOVE], // 1-WORK 2-CARRY 3-MOVE
    [WORK, WORK, WORK, WORK, WORK, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 5-WORK 1-CARRY 6-MOVE
    [WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 5-WORK 5-CARRY 10-MOVE
  ]
};
