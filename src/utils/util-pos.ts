...
export function findAtPos<T extends _HasRoomPosition>(pos: RoomPosition, objects: T[]): T | undefined {

  return objects.find(o => o.pos.roomName == pos.roomName && o.pos.x == pos.x && o.pos.y == pos.y);
